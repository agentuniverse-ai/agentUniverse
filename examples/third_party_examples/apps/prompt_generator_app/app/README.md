# agentUniverse- Prompt Generator App
## Introduction
This project is a sample application for the agentUniverse prompt generation and optimization capabilities.

## Quick Start
You can run this project based on the [Quick Start](https://github.com/agentuniverse-ai/agentUniverse/blob/master/docs/guidebook/en/Get_Start/2.Run_Your_First_Tutorial_Example.md).
