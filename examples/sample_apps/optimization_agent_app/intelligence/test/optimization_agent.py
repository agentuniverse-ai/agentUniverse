...
def run_optimization():
    ...
    input_data1 = {
        "samples": [
            ...
            {"fund_info":"“中航机遇领航混合C”是一只混合型-偏股基金，投向通信行业。近1年超额收益率64.65%，优于98%同赛道基金，稳定投向通信赛道，持仓重合度57.45%。","user_info":"用户最近在科技、军工、医药等成长板块基金上积极布局。"},
            {"fund_info":"“嘉实上海金ETF联接C”是一只黄金基金，跟踪上海金指数。近1年最大回撤10.10%，优于88%同指数基金。","user_info":"用户没有持有黄金基金。"},
        ...
        "batch_size": 2,
        "max_iterations": 5,
        "scoring_standard": "总分100分,不满足金融合规要求或存在事实性错误则直接得0分。在符合金融合规要求且无事实性错误的前提下，按（1）具有说服力和吸引力（上限25分）（2）易于理解（上限25分）（3）风格鲜明生动（上限25分）（4）重点突出（上限25分）给出总分评分。",
