...
from typing import Optional, Any, AsyncIterator, Iterator, Union, Dict
...
from agentuniverse.llm.llm_output import LLMOutput, LLMStreamEvent
...
class LLM(ComponentBase):
    ...
    # api_base override client pool
    _client_pool: Dict[str, Any] = {}
    _async_client_pool: Dict[str, Any] = {}
    ...
    @abstractmethod
    def _call(self, *args: Any, **kwargs: Any) -> Union[LLMOutput, Iterator[LLMStreamEvent]]:
        """Run the LLM."""

    @abstractmethod
    async def _acall(self, *args: Any, **kwargs: Any) -> Union[LLMOutput, AsyncIterator[LLMStreamEvent]]:
    ...
    def initialize_by_component_configer(self, component_configer: LLMConfiger) -> 'LLM':
        ...
        if component_configer.max_tokens is not None:
    ...
    def call(self, *args: Any, **kwargs: Any):
        ...
        try:
            ...
            LOGGER.error(f'Error in LLM call: {traceback.format_exc()}')
            raise e
    ...
    async def acall(self, *args: Any, **kwargs: Any):
        ...
        try:
            ...
            LOGGER.error(f'Error in LLM acall: {traceback.format_exc()}')
            raise e
    ...
    def create_copy(self):
        ...
        copied._client_pool = self._client_pool
        copied._async_client_pool = self._async_client_pool
        return copied
