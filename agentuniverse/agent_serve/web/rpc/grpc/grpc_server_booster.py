...
from agentuniverse.agent_serve.web.rpc.grpc import agentuniverse_service_pb2, agentuniverse_service_pb2_grpc
...
class AgentUniverseService(agentuniverse_service_pb2_grpc.AgentUniverseService):
    ...
    def service_run(self, request, context):
        ...
        Return:
            ...
            result: This key points to a nested dictionary that includes the
                result of the task.
        """
        service_result = service_run(saved=request.saved, params=request.params, service_id=request.service_id)
    ...
    def service_run_async(self, request, context):
        ...
        """
        service_result = service_run_async(saved=request.saved, params=request.params, service_id=request.service_id)
        return agentuniverse_service_pb2.AgentServiceResponse(
            result=service_result["result"],
            request_id=service_result["request_id"],
            success=service_result["success"],
    ...
    def service_run_result(self, request, context):
        ...
        Return:
            ...
            result: This key points to a nested dictionary that includes the
                result of the task.
        """
        service_result = service_run_result(request_id=request.request_id)
        return agentuniverse_service_pb2.AgentServiceResponse(
            result=service_result["result"],
            request_id=service_result["request_id"],
            success=service_result["success"],
...
def start_grpc_server():
    ...
    agentuniverse_service_pb2_grpc.add_AgentUniverseServiceServicer_to_server(AgentUniverseService(), server)
