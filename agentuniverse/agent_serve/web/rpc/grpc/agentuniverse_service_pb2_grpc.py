...
from agentuniverse.agent_serve.web.rpc.grpc import agentuniverse_service_pb2 as agentuniverse__service__pb2
...
def add_AgentUniverseServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("agentuniverse.AgentUniverseService", rpc_method_handlers)
