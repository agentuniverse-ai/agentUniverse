...
class ConfigStorage:
    ...
    def load_from_storage(self, ctx: StorageContext) -> None:
        """
    ...
    def persist_to_storage(self, ctx: StorageContext) -> None:
        ...
        """
        if not self.persist or not ctx.trimmed_path:
            return
    ...
    def _build_context(self, configer: Configer, config_type: ComponentEnum) -> StorageContext:
