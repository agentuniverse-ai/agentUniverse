...
class PromptScoringAgentTemplate(AgentTemplate):
    ...
    def initialize_by_component_configer(self, component_configer: AgentConfiger) -> 'PromptScoringAgentTemplate':
        """Initialize the Agent by the AgentConfiger object.

        Args:
            component_configer(AgentConfiger): the ComponentConfiger object
        Returns:
            PromptScoringAgentTemplate: the PromptScoringAgentTemplate object
        """
        super().initialize_by_component_configer(component_configer)
        self.prompt_version = self.agent_model.profile.get('prompt_version', 'default_prompt_scoring_agent.cn')
