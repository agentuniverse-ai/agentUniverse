...
class RewriteAgentTemplate(AgentTemplate):
    ...
    def parse_input(self, input_object: InputObject, agent_input: dict) -> dict:
        ...
        agent_input['draft'] = input_object.get_data('draft')
        agent_input['critique_result'] = input_object.get_data('critique_result')
    ...
    def parse_result(self, agent_result: dict) -> dict:
        ...
        output = agent_result.get('rewrite_result')
        final_result['rewrite_result'] = output

        # add write agent log info.
        logger_info = f"\nCritique agent execution result is :\n"
        LOGGER.info(logger_info + output)
