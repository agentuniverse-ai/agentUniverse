...
class Agent(ComponentBase, ABC):
    ...
    def execute(self, input_object: InputObject, agent_input: dict) -> dict:
        ...
        """
        planner_base: Planner = PlannerManager().get_instance_obj((self.agent_model.plan.get('planner') or {}).get('name'))
    ...
    def as_langchain_tool(self):
        ...
        return LangchainTool(
            ...
            description=(self.agent_model.info.get("description") or "") + args_description
        )
