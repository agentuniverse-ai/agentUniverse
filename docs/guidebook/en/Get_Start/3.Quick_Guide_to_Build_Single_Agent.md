...
LLMs implement the call and acall methods to handle model invocation logic. The call method serves as the main logic. In the example, both streaming and non-streaming implementations of HTTP model request calls are provided.
